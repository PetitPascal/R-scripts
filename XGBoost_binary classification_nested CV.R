...
pack_needed<-c("data.table","tidyverse","mllrnrs","broom","doParallel","foreach",
               ...
               "mlexperiments","caret","MLmetrics","patchwork", "shapviz",
...
# Exporting plot
ggsave(plot5,file=paste("SHAP direction comparison_",Sys.Date(),".pdf",sep=""),dpi=600,width=60,height=30,units = "cm",limitsize=F)
...
shap_interaction_summary(xgb_final, X_test, feature_cols)
