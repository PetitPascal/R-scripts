...
xgb.save(final_mod,paste0("XGBoost_model_",Sys.Date(),".ubj"))
...
## Exporting the graph
ggsave(plot1,file=paste("Importance_Top 50_",Sys.Date(),".pdf",sep=""),dpi=600,width=40,height=30,units="cm",limitsize=F)
...
# Exporting plot
ggsave(plot0,file=paste("SHAP direction comparison_",Sys.Date(),".pdf",sep=""),dpi=600,width=60,height=30,units = "cm",limitsize=F)
...
# Exporting plot 1
ggsave(plot1,file=paste("SHAP_top 50_v1_",Sys.Date(),".pdf",sep=""),dpi=600,width=60,height=30,units="cm",limitsize=F)
...
# Exporting plot 2
ggsave(plot2,file=paste("SHAP_top 50_v2_",Sys.Date(),".pdf",sep=""),dpi=600,width=60,height=30,units="cm",limitsize=F)

## Plot 3: SHAP percentage contribution 
...
# Exporting plot 3
ggsave(plot3,file=paste("SHAP_contribution_",Sys.Date(),".pdf"),dpi=600,width=60,height=30,units="cm",limitsize=FALSE)
